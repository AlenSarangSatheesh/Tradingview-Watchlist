...
const KNOWN_INDEX_MAP = {
  // Broad Market & Sectoral Indices (NSE)
  'NIFTYINDIAMFG': 'NSE:NIFTY_INDIA_MFG',
  'NIFTYINDMFG': 'NSE:NIFTY_INDIA_MFG',
  'NIFTY_IND_MFG': 'NSE:NIFTY_INDIA_MFG',
  'NIFTYMULTIMFG': 'NSE:NIFTY_MULTI_MFG',
  'NIFTY_MULTI_MFG': 'NSE:NIFTY_MULTI_MFG',
  'NIFTYMULTIINFRA': 'NSE:NIFTY_MULTI_INFRA',
  'NIFTY_MULTI_INFRA': 'NSE:NIFTY_MULTI_INFRA',
  'NIFTYHEALTHCARE': 'NSE:NIFTY_HEALTHCARE',
  'NIFTY_HEALTHCARE': 'NSE:NIFTY_HEALTHCARE',
  'NIFTYLARGEMID250': 'NSE:NIFTY_LARGEMID250',
  'NIFTY_LARGEMID250': 'NSE:NIFTY_LARGEMID250',
  'NIFTY500MULTICAP': 'NSE:NIFTY500_MULTICAP',
  'NIFTY500_MULTICAP': 'NSE:NIFTY500_MULTICAP',
  'NIFTYTATA25CAP': 'NSE:NIFTY_TATA_25_CAP',
  'NIFTY_TATA_25_CAP': 'NSE:NIFTY_TATA_25_CAP',
  'NIFTYTOTALMKT': 'NSE:NIFTY_TOTAL_MKT',
  'NIFTY_TOTAL_MKT': 'NSE:NIFTY_TOTAL_MKT',
  'NIFTYMIDSELECT': 'NSE:NIFTY_MID_SELECT',
  'NIFTY_MID_SELECT': 'NSE:NIFTY_MID_SELECT',
  'NIFTYSMALLCAP250': 'NSE:NIFTYSMLCAP250',
  'NIFTYSMLCAP250': 'NSE:NIFTYSMLCAP250',
  'NIFTYSMALLCAP50': 'NSE:NIFTYSMLCAP50',
  'NIFTYSMLCAP50': 'NSE:NIFTYSMLCAP50',
  'NIFTYSMALLCAP100': 'NSE:CNXSMALLCAP',
  'NIFTYSMALLCAP': 'NSE:CNXSMALLCAP',
  'NIFTYSMLCAP100': 'NSE:CNXSMALLCAP',
  'NIFTYSMLCAP': 'NSE:CNXSMALLCAP',
  'NIFTYMICROCAP250': 'NSE:NIFTY_MICROCAP250',
  'NIFTY_MICROCAP250': 'NSE:NIFTY_MICROCAP250',
  'NIFTYMIDSML400': 'NSE:NIFTYMIDSML400',
  'NIFTYMIDCAP50': 'NSE:NIFTYMIDCAP50',
  'NIFTYMIDCAP150': 'NSE:NIFTYMIDCAP150',
  'NIFTYMIDLIQ15': 'NSE:NIFTYMIDLIQ15',
  'NIFTY50TR2XLEV': 'NSE:NIFTY',
  'NIFTY200': 'NSE:CNX200',
  'CNX200': 'NSE:CNX200',
  'NIFTY100': 'NSE:CNX100',
  'CNX100': 'NSE:CNX100',
  ...
  'NIFTYCOMMODITIES': 'NSE:CNXCOMMODITIES',
  'CNXCOMMODITIES': 'NSE:CNXCOMMODITIES',
  'NIFTYCONSUMPTION': 'NSE:CNXCONSUMPTION',
  'CNXCONSUMPTION': 'NSE:CNXCONSUMPTION',
  'NIFTYPSE': 'NSE:CNXPSE',
  'CNXPSE': 'NSE:CNXPSE',
  'NIFTYPSUBANK': 'NSE:CNXPSUBANK',
  'CNXPSUBANK': 'NSE:CNXPSUBANK',
  'NIFTYSERVICE': 'NSE:CNXSERVICE',
  'NIFTYSERVICES': 'NSE:CNXSERVICE',
  ...
  'NIFTYOILGAS': 'NSE:NIFTY_OIL_AND_GAS',
  'NIFTYOILANDGAS': 'NSE:NIFTY_OIL_AND_GAS',
  'NIFTY_OIL_AND_GAS': 'NSE:NIFTY_OIL_AND_GAS',
  'NIFTYCONSRDURBL': 'NSE:NIFTY_CONSR_DURBL',
  'NIFTY_CONSR_DURBL': 'NSE:NIFTY_CONSR_DURBL',
  'NIFTYDEFENCE': 'NSE:NIFTY_IND_DEFENCE',
  'NIFTYINDDEFENCE': 'NSE:NIFTY_IND_DEFENCE',
  'NIFTY_IND_DEFENCE': 'NSE:NIFTY_IND_DEFENCE',
  'NIFTYTOURISM': 'NSE:NIFTY_IND_TOURISM',
  'NIFTYINDTOURISM': 'NSE:NIFTY_IND_TOURISM',
  'NIFTY_IND_TOURISM': 'NSE:NIFTY_IND_TOURISM',
  'NIFTYDIGITAL': 'NSE:NIFTY_IND_DIGITAL',
  'NIFTYINDDIGITAL': 'NSE:NIFTY_IND_DIGITAL',
  'NIFTY_IND_DIGITAL': 'NSE:NIFTY_IND_DIGITAL',
  'NIFTYCHEMICALS': 'NSE:NIFTY_CHEMICALS',
  'NIFTY_CHEMICALS': 'NSE:NIFTY_CHEMICALS',
  'NIFTYCAPITALMKT': 'NSE:NIFTY_CAPITAL_MKT',
  'NIFTY_CAPITAL_MKT': 'NSE:NIFTY_CAPITAL_MKT',
  'NIFTYCEMENT': 'NSE:NIFTY_CEMENT',
  'NIFTY_CEMENT': 'NSE:NIFTY_CEMENT',
  'NIFTYIPO': 'NSE:NIFTY_IPO',
  'NIFTY_IPO': 'NSE:NIFTY_IPO',
  'NIFTYRURAL': 'NSE:NIFTY_RURAL',
  'NIFTY_RURAL': 'NSE:NIFTY_RURAL',
  'NIFTYWAVES': 'NSE:NIFTY_WAVES',
  'NIFTY_WAVES': 'NSE:NIFTY_WAVES',
  'NIFTYHOUSING': 'NSE:NIFTY_HOUSING',
  'NIFTY_HOUSING': 'NSE:NIFTY_HOUSING',
  'NIFTYSMALLCAP500': 'NSE:NIFTY_SMALLCAP_500',
  'NIFTY_SMALLCAP_500': 'NSE:NIFTY_SMALLCAP_500',
  'NIFTYMOBILITY': 'NSE:NIFTY_MOBILITY',
  'NIFTY_MOBILITY': 'NSE:NIFTY_MOBILITY',
  'CPSE': 'NSE:CPSE',
  // BSE Indices
  'SENSEX': 'BSE:SENSEX',
...
async function getTradingViewSymbol(stock) {
  ...
  // Check known index aliases (from Chartink / NSE / BSE)
  const cleanSymKey = sym.toUpperCase().replace(/[^A-Z0-9]/g, '');
  if (KNOWN_INDEX_MAP[cleanSymKey]) {
    return KNOWN_INDEX_MAP[cleanSymKey];
  }
